...
> **⏸ 2026-08-06 보류 결정** — 실사 필름은 진행하지 않기로 함(오너 결정).
> 현행 브랜드 영상은 홈의 모션그래픽 티저(assets/film/teaser.mp4)로 유지.
> 생성된 스틸 7컷은 assets/stills/로 회수해 OG 공유 카드 등에 활용 중.
> 이 문서는 향후 재개 시 재사용할 수 있도록 보관.
